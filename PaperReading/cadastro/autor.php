		...
		<div id="loginModal" class="modal show" tabindex="-1" role="dialog" aria-hidden="true" style="background-color: rgba(0,0,0,0.6); top: 50px; overflow-y: scroll;">
		  ...
		  <div class="modal-content" style="top: 0px;">
		      <div class="modal-header">
		          <h1 class="text-center">Registro Autor</h1>
		      </div>
		      <div class="modal-body">
		          <form class="form col-md-12 center-block" name="formPagina" method="post" action="salvarCadastro/autor.php">
		            <?php
				        ...
				        echo ("</select>");
				    	writeInput("Telefone", "text", "tTel", "9", "tTel", "");
				    	echo "<br/>";
				    	writeInput("Cidade", "text", "tCidade", "90", "tCidade", "");
